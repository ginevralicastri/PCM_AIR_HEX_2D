...
# === Load Data ===
input_data = pd.read_excel("data/winter.xlsx")
...
def objective_function(k_factor):
    ...
    return rmse, air_temp  # Return the error and air_temp array

# === Run Optimization ===
result = minimize_scalar(lambda k: objective_function(k)[0], bounds=(0.1, 30), method='bounded')
optimal_k = result.x
